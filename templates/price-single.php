...
if ( $reg_price_output ) {
	echo '<div><del>';
	echo '<span class="amount"><span class="label">Regular Price: </span>', $reg_price_output, '</span>';
	echo '</del></div>';
}

if ( $price_output ) {
	if ( $reg_price_output ) echo '<div><ins>';
	echo '<span class="amount">';
		if ( $reg_price_output ) echo '<span class="label">Sale Price: </span>';
		echo $price_output;
	echo '</span>';
	if ( $reg_price_output ) echo '</ins></div>';
}
